...
impl SoftbanService {
    ...
    pub async fn fetch_guild_softbans(&self, guild_id: GuildId, page: NonZeroU32) -> Vec<Softban> {
        self.repository
            .fetch_guild_softbans(guild_id.0 as i64, page.get())
            .await
            .map_err(|err| {
    ...
    pub async fn fetch_guild_softban_count(&self, guild_id: GuildId) -> i64 {
        self.repository
            .fetch_guild_softban_count(guild_id.0 as i64)
            .await
            .map_err(|err| {
    ...
    pub async fn fetch_actionable_softban_count(&self, guild_id: GuildId, user_id: UserId) -> i64 {
        self.repository
            .fetch_actionable_softban_count(guild_id.0 as i64, user_id.0 as i64)
            .await
            .map_err(|err| {
