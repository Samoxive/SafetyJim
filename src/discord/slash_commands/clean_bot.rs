...
struct CleanBotCommandOptions {
    number: i64,
}

enum CleanBotCommandOptionFailure {
    MissingOption,
    OutOfRangeError(i64),
}
...
fn generate_options(
    ...
    Ok(CleanBotCommandOptions { number })
}
...
#[async_trait]
impl SlashCommand for CleanBotCommand {
    fn command_name(&self) -> &'static str {
        "clean-bot"
    }

    fn create_command(&self) -> CreateApplicationCommand {
        CreateApplicationCommand::new("clean-bot")
